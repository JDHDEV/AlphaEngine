...
public:
	...
	virtual shared_ptr<IRenderState> VPrepareWireFramePass()=0;
...
public:
	...
	virtual BoundingBox * VGetBox()=0;
	virtual BoundingSphere * VGetSphere()=0;
	...
	virtual bool VHasMoved() const=0;
...
// class IRenderable                                     
//
//   This is the public interface for Renderable instances in a 3D scene graph.
/////////////////////////////////////////////////////////////////////////////
class IRenderable
{
public:
	virtual HRESULT VOnRestore(Scene *pScene)=0;
	virtual HRESULT VRender(Scene *pScene)=0;
	virtual bool VAddInstance(RenderableInstance* instance)=0;
	//virtual HRESULT VOnLostDevice(Scene *pScene)=0;

	virtual const RenderableProperties* const VGet() const=0;
	virtual int VGetInstanceCount() =0;
	virtual bool VIsRendering()=0;
	virtual void VSetRendering(bool rendering)=0;
	virtual ~IRenderable() { };
};

typedef shared_ptr<IRenderable> StrongRenderablePtr;
typedef weak_ptr<IRenderable> WeakRenderablePtr;
