...
public:
	...
	virtual void VSerialize(std::ostrstream& out) const = 0;//TODO:cahnge to ostream later
	virtual void VDeserialize(std::istrstream& in) = 0;//TODO:cahnge to istream later
...
public:
	...
	virtual void VSerialize(std::ostrstream &out) const { }//TODO:cahnge to ostream later
	virtual void VDeserialize(std::istrstream& in) { }//TODO:cahnge to istream later
};
