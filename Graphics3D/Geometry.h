...
// Why is this called unlit? does this not interact with the lights? or does this mean that the vertex dosent emit light?
...
{
public:
	enum Side { Near, Top, Right, Bottom, Left, Far, NumPlanes};
	int totalPlanes;
