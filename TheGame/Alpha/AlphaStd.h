#pragma once
//========================================================================
// AlphaStd.h : include file for standard system include files,
...
class AC_noncopyable 
{  
	private:  
	AC_noncopyable(const AC_noncopyable& x);  
	AC_noncopyable& operator=(const AC_noncopyable& x);  
	public:  
	AC_noncopyable() {}; // Default constructor  
};  

// Game Code Complete - Chapter 12, page 446-447
#if defined(_DEBUG)
#       define AC_NEW new(_NORMAL_BLOCK,__FILE__, __LINE__)
#else
#       define AC_NEW new
#endif
...
#include "..\..\DirectX11Wrapper\DirectX.h"
...
extern INT WINAPI Alpha(HINSTANCE hInstance,
