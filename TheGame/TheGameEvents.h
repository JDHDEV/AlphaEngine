#pragma once
//========================================================================
// TheGameEvents.h : defines game-specific events for TeapotWars
//
...
//-----------------------------------------------------------------------------------------------------------------------
// class EvtData_Spawn_Brick				- Chapter 10, 279
...
//---------------------------------------------------------------------------------------------------------------------
class EvtData_Spawn_Brick : public ScriptEvent
{
	Mat4x4 m_pos;
...
public:
    ...
    EvtData_Spawn_Brick(void)
    {
		m_pos.BuildTranslation(0.0f, 0.0f, 0.0f);
    }

    EvtData_Spawn_Brick(Mat4x4 pos)
        : m_pos(pos)
    {
    }
    ...
    {
        return IEventDataPtr(AC_NEW EvtData_Spawn_Brick(m_pos));
    }
    ...
    virtual bool VBuildEventFromScript(void)
    {
        ...
        //    else
        //    {
        //        AC_ERROR("Invalid id sent to EvtData_Fire_Weapon; type = " + std::string(temp.TypeName()));
        //        return false;
        //    }
        //    return true;
        //}
    ...
    EXPORT_FOR_SCRIPT_EVENT(EvtData_Spawn_Brick);
};
...
//    virtual IEventDataPtr VCopy() const
//    {
//        return IEventDataPtr(AC_NEW EvtData_Gameplay_UI_Update(m_gameplayUiString));
//    }
//
//    virtual void VSerialize(std::ostrstream& out) const
//    {
