...
unsigned int ACRandom::Random(unsigned int n)
{
    unsigned long y;
...
void ACRandom::SetRandomSeed(unsigned int n)
{
...
unsigned int ACRandom::GetRandomSeed(void)
{
	return(rseed);
}

void ACRandom::Randomize(void)
{
