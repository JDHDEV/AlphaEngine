...
//========================================================================
//
//  Original Code written at Compulsive Development shamelessly lifted by 
//	Justin Hunt
//
//========================================================================
...
public:
    ...
    {
		AC_ASSERT(! (this == & other));        // don't copy over self!
		if (m_bValid)
    ...
    T const & operator * () const { AC_ASSERT(m_bValid); return * GetT(); }
    T & operator * () { AC_ASSERT(m_bValid); return * GetT(); }
    T const * const operator -> () const { AC_ASSERT(m_bValid); return GetT(); }
    T * const operator -> ()  { AC_ASSERT(m_bValid); return GetT(); }
